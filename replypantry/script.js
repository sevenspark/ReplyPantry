...
(function () {
	...
	function canEntry(key, val, cat){
		return $('<li class="cankey-op" data-key="'+key+'" data-cat="'+cat+'" > '+
					...
					'<a href="#" data-key="'+key+'" class="cankey-edit" title="Edit Can"><img src="'+chrome.extension.getURL('edit.png')+'" title="Edit" alt="edit" /></a> '+
				'</li>');
	}
	...
	function construct(){
		...
		var $canbutton = $('<a href="#" id="canbutton"><img src="'+chrome.extension.getURL('can.png')+'" title="Reply in a can" /></a>');
	...
	//Load styles
	$('head').append('<link type="text/css" rel="stylesheet" href="'+chrome.extension.getURL('style.css')+'" />');
